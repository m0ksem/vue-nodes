...
<template>
  <DemoNode :title="node.title">
    <template #inputs>
      <DemoButton color="red" @register-point="registerPoint(node, 'r')($event)" @circle-click="$emit('connect-to', 'r')">
        <DemoInput v-model="node.points['r'].value"/>
      </DemoButton>
      <DemoButton color="red" @register-point="registerPoint(node, 'g')($event)" @circle-click="$emit('connect-to', 'g')">
        <DemoInput v-model="node.points['g'].value"/>
      </DemoButton>
      <DemoButton color="red" @register-point="registerPoint(node, 'b')($event)" @circle-click="$emit('connect-to', 'b')">
        <DemoInput v-model="node.points['b'].value"/>
      </DemoButton>
    </template>
